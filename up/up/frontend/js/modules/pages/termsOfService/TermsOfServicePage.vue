<template>
    <BasePage headerTitle="Terms and Conditions">
        <div class="row">
            <div class="card-custom col">
                <p><b>Last updated: October 26, 2021</b></p>
                ...
                <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Uprove, Inc., 1400 Esplanade Ct, Apt 429, Reston, VA 20194.</p>
                </li>
                <li>
                ...
                <li>
                <p><strong>Website</strong> refers to Uprove, accessible from <a href="www.uprove.co" rel="external nofollow noopener" target="_blank">www.uprove.co</a></p>
                </li>
                <li>
                ...
                <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at legal@uprove.co and include in Your notice a detailed description of the alleged infringement.</p>
                ...
                <p>You can contact our copyright agent via email at legal@uprove.co.
                ...
                <ul>
                <li>
                <p>By email: info@uprove.co</p>
                </li>
                <li>
                <p>By visiting this page on our website: <a href="www.uprove.co/contact" rel="external nofollow noopener" target="_blank">www.uprove.co/contact</a></p>
                </li>
                </ul>
            </div>
        </div>
