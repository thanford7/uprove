<template>
    <BasePage headerTitle="Privacy Policy">
        <div class="row">
            <div class="col card-custom">
                ...
                <li>
                <p><strong>Website</strong> refers to Uprove, accessible from <a href="https://www.uprove.co" rel="external nofollow noopener" target="_blank">https://www.uprove.co</a></p>
                </li>
                <li>
                ...
                <p>Their Privacy Policy can be viewed at <a href="www.twilio.com/legal/privacy" rel="external nofollow noopener" target="_blank">www.twilio.com/legal/privacy</a></p>
                </li>
                </ul>
                <h2>Payments</h2>
