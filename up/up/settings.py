...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'up/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
AWS_ACCESS_KEY_ID = 'ALYBPKSC6EBXTCX2FLEX'
AWS_SECRET_ACCESS_KEY = 'Lmj+pXQDVL1kmgF/+hCB65+O5FAAqQSLKi2OgsoXJZY'
AWS_STORAGE_BUCKET_NAME = 'uprove-upload'
